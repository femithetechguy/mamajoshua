...
export default function CTAWithShare({ message }: { message: string }) {
    ...
    <>
      <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs font-semibold text-gray-400 uppercase tracking-wider">or share</span>
          <div className="flex-1 h-px bg-gray-100" />
        </div>

        {/* Share icons row */}
        <div className="flex items-center gap-3">
          <span className="text-xs text-gray-400 font-medium">Spread the word</span>
          <div className="flex gap-2 ml-auto">
            ...
            <button
              ...
              className="w-9 h-9 flex items-center justify-center rounded-full bg-[#25D366] hover:bg-[#1ebe5d] active:bg-[#18a84f] text-white transition-all hover:scale-110 active:scale-95"
            >
            ...
            <button
              ...
              className="w-9 h-9 flex items-center justify-center rounded-full bg-[#34C759] hover:bg-[#2db84e] active:bg-[#28a546] text-white transition-all hover:scale-110 active:scale-95"
            >
            ...
            <button
              ...
              className={`w-9 h-9 flex items-center justify-center rounded-full border transition-all hover:scale-110 active:scale-95 ${
                copied
