    ...
    <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
      ...
      <div className="flex gap-3">
        ...
        <button
          ...
          className="flex-1 flex items-center justify-center gap-2.5 bg-[#25D366] hover:bg-[#1ebe5d] active:bg-[#18a84f] text-white py-3 px-4 rounded-xl transition-colors"
        >
        ...
        <button
          onClick={copyLink}
          className={`flex-1 flex items-center justify-center gap-2.5 py-3 px-4 rounded-xl border transition-colors ${
            copied
