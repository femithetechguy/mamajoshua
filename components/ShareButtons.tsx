    ...
    <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
      ...
      <div className="flex gap-3">
        ...
        <button
          ...
          className="w-10 h-10 flex items-center justify-center rounded-full bg-[#25D366] hover:bg-[#1ebe5d] active:bg-[#18a84f] text-white transition-colors"
        >
        ...
        <button
          ...
          className="w-10 h-10 flex items-center justify-center rounded-full bg-[#34C759] hover:bg-[#2db84e] active:bg-[#28a546] text-white transition-colors"
        >
